...
def create_accent_grammar(list_of_tracks, num_files_per_group, num_plays,
    num_copies=1, prefix='', to_mp3=False, artist='Accent', album='Accent Training', shuffled='', silence_padding='0', grammar=False):
    ...
    generate_from_list_of_files(input_files, type_file +'/' + type_file +'VN/', type_file, False, silence_padding)
